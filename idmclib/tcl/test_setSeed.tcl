...
for {set i 0} {$i < 1000} {incr i} {
	...
	stopifnot ![string compare [array2list $ans 9] "0.6335290032438934 1.0416814025536334 3.0 -1.060974674386749 1.3596270116146407 0.4230486538392224 39.54387606845883 2.1193675889803747 -9.257081853478832"]
}
